...
public class QrcodeUtil {
     ...
     * @param text 样式字符串文本
     */
    public static QrcodeUtil.Builder builder(@NonNull CharSequence text) {
        return new QrcodeUtil.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = QrcodeUtil.creatQRCode(content, codeSide, codeSide, backgroundColor, codeColor);
            if (imageView != null) {
