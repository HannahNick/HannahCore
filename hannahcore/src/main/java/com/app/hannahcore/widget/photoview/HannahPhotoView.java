package com.app.hannahcore.widget.photoview;
 ...
 */
public class HannahPhotoView extends AppCompatImageView {
    ...
    public HannahPhotoView(Context context) {
        this(context,null);
    }

    public HannahPhotoView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public HannahPhotoView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(HannahPhotoView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(HannahPhotoView.this);
            }
        }
